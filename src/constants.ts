export const PROFILE = {
  ...
  resumeUrl:
    "https://drive.google.com/file/d/1K2J6FfYdqhbhPequV5HH0G2T3qprBjcI/view?usp=drive_link",
  links: {
...
export const SKILLS = [
  ...
  { name: "TanStack Query", icon: "search-check" },
  { name: "RESTful APIs", icon: "network" },
  { name: "Socket.io", icon: "radio" },
  { name: "Microservices Architecture", icon: "blocks" },
  { name: "AWS", icon: "cloud" },
  { name: "EC2, S3, Lambda, RDS, VPC", icon: "cloud-cog" },
  { name: "Terraform", icon: "hammer" },
  { name: "CI/CD", icon: "git-merge" },
  { name: "Github Action", icon: "play-circle" },
  { name: "Linux", icon: "terminal" },
  { name: "Bash scripting", icon: "terminal-square" },
  { name: "Prisma ORM", icon: "table-properties" },
  { name: "JWT", icon: "key-round" },
  { name: "OAuth 2.0", icon: "shield-check" },
  { name: "RBAC", icon: "users-round" },
  { name: "Session Management", icon: "clock-3" },
  { name: "XSS/CSRF Prevention", icon: "shield-alert" },
];
